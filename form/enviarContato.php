...
if (!$token) {
    ...
    if ((!$res['success'])) {
        $data['message'] = "reCAPTCHA inválido!";
        $data['sucesso'] = false;
    } else {
                        ...
                        <table width='694' border='0' align='center' cellpadding='0' cellspacing='0'>
                            <tbody>
                                <tr>
                                    ...
                                    Abaixo dados enviados através do formulário
        ...
        $mail = new Email(SMTP_HOST, MAIL_SENDER, MAIL_PASS, 'Contato do Site');
        $mail->addAdress(MAIL_RECEIVE, NAME_RECEIVE);
